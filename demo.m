...
%% First example: positively correlated activities in ROI1 and one-to-one voxel mapping
fnam = 'Positively correlated activities in ROI1 and one-to-one voxel mapping';
%T = rand(nVoxs);
